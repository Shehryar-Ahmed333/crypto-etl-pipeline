...
# # ==========================================
# # 1. EXTRACT (Internet se live data nikaalna)
# # ==========================================
# def extract_data():
#     print("🔄 1. Internet se live Crypto data nikaal rahe hain (Extracting)...")
#     url = "https://api.coingecko.com/api/v3/coins/markets"
#     params = {
#         'vs_currency': 'usd',
#         'order': 'market_cap_desc',
#         'per_page': 10,  # Top 10 coins ka data
#         'page': 1
#     }
...
# # ==========================================
# # 2. TRANSFORM (Pandas se data ko saaf/set karna)
# # ==========================================
# def transform_data(raw_data):
#     print("🧹 2. Pandas use kar ke data ko clean kar rahe hain (Transforming)...")
#     df = pd.DataFrame(raw_data)
    
#     # Sirf kaam ke columns select kar rahe hain
#     columns_to_keep = ['id', 'name', 'symbol', 'current_price', 'market_cap', 'total_volume']
#     df = df[columns_to_keep]
    
#     # Cleaning: Agar kahin khali (Null) value hai to 0 kar do
#     df.fillna({'current_price': 0, 'market_cap': 0, 'total_volume': 0}, inplace=True)
    
#     # Data Engineering standard: Ek extra column jo bataye data kab load hua
#     df['extracted_at'] = datetime.now()
    
#     return df

# # ==========================================
# # 3. LOAD (SQLAlchemy ke zariye PostgreSQL mein bhejna)
# # ==========================================
# def load_data(df):
...
#     # Pandas ka poora table aik line mein PostgreSQL ke naye table 'live_cryptos' mein chala jayega
#     df.to_sql('live_cryptos', con=engine, if_exists='replace', index=False)
#     print("🎉 ETL Pipeline successfully chal gayi! Data 'live_cryptos' table mein save ho gaya.")

# # ==========================================
# # Main Execution (Yahan se code chalna shuru hota hai)
# # ==========================================
...
#         print(f"❌ Pipeline fail ho gayi! Wajah: {e}")
